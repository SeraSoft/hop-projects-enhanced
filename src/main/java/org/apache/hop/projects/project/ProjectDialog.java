...
public class ProjectDialog extends Dialog {
  ...
  public String open() {
    ...
    Label wlLinkedProject = new Label(shell, SWT.RIGHT);
    ...
    fdlLinkedProject.right = new FormAttachment(middle, -margin);
    fdlLinkedProject.top = new FormAttachment(lastControl, margin);
    wlLinkedProject.setLayoutData(fdlLinkedProject);
    wLinkedProject = new ComboVar(variables, shell, SWT.SINGLE | SWT.BORDER | SWT.LEFT);
    PropsUi.setLook(wLinkedProject);
    FormData fdLinkedProject = new FormData();
    fdLinkedProject.left = new FormAttachment(middle, 0);
    fdLinkedProject.right = new FormAttachment(100, -margin);
    fdLinkedProject.top = new FormAttachment(lastControl, margin);
